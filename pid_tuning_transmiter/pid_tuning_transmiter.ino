...
void printPackage() {
  ...
  Serial.print("Yaw: ");            Serial.println(packageForSend.yaw);
  Serial.print("Pitch: ");          Serial.println(packageForSend.pitch);
  Serial.print("Roll: ");           Serial.println(packageForSend.roll);
